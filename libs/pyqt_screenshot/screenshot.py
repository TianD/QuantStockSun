#!/usr/bin/python3
# coding:utf-8
from PySide2.QtCore import QRect, QPoint, QRectF, QSize, QLineF, QPointF, QEventLoop
from PySide2.QtGui import QColor, QPainterPath, QKeySequence, QGuiApplication, QPixmap, QPen, QBrush, QImage, QPainter, \
    QPolygonF, QClipboard, QCursor, QMouseEvent, QPen
from PySide2.QtWidgets import QGraphicsView, QApplication, QGraphicsScene, QShortcut, QFileDialog, QDialog
...
class Screenshot(QGraphicsView):
    ...
    def drawSizeInfo(self):
        ...
        self.items_to_remove.append(self.graphics_scene.addRect(QRectF(sizeInfoArea), QPen(Qt.white), QBrush(Qt.black)))
